            ...
            else
            {
                if(ui16TempCounter >= 100)
                {
                    ...
                    else
                    {
                        ...
                        Serial.println("FOTA TASK SUSPENSED!\n");
                        vTaskSuspend(NULL); 
                    }
                    ui16TempCounter = 0;
                }
...
void esp32FOTA::execOTASpecial()
{
    ...
    Serial.println("Connecting to: --> execOTASpecial " + String(_host));
...
void esp32FOTA::execOTA()
{
    ...
    Serial.println("Connecting to:--> execOTA " + String(_host));
    // Connect to Webserver
    if (client.connect(_host.c_str(), _port))
    {
        // Connection Succeed.
